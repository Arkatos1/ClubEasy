...
.tournament-bracket .match-wrapper {
    ...
    width: 150px;
    background-color: #f5f5f5;
    padding: 0; /* Remove padding to match demo */
}
...
.tournament-bracket .match-divider {
    ...
    margin: 0; /* Remove margin to match demo */
}
...
.tournament-bracket .vertical-connector {
    border-left: 3px solid #cdc9c9 !important; /* Match demo thickness */
    width: 3px;
}

.tournament-bracket .horizontal-connector {
    border-top: 3px solid #cdc9c9 !important; /* Match demo thickness */
    width: 20px;
}

/* Player and score styling from demo */
...
/* Success state from demo */
.tournament-bracket #success {
    background-color: #DFF2BF !important;
}

/* Fix for form elements to prevent overlap */
...
/* Bootstrap form styling only for our custom forms */
...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <!-- Tournament Creation Form - Uses Bootstrap -->
            ...
            @if($tournament && $tournament->championships->count() > 0)
                @foreach($tournament->championships as $championship)
                    <div class="mb-8 p-6 border border-gray-200 rounded-lg">
                        ...
                        <!-- Tournament Trees - WRAP IN TOURNAMENT-BRACKET CLASS -->
