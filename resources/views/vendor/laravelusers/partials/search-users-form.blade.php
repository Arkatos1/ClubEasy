    ...
    <div class="col-sm-8 offset-sm-4 col-md-6 offset-md-6 col-lg-5 offset-lg-7 col-xl-4 offset-xl-8">
        <form method="POST" action="{{ route('search-users') }}" role="form" class="needs-validation" id="search_users">
            ...
            <div class="input-group mb-3">
                <input type="text" name="user_search_box" id="user_search_box" class="form-control" value="{{ old('user_search_box') }}" placeholder="{{ trans('laravelusers::forms.search-users-ph') }}" aria-label="{{ trans('laravelusers::forms.search-users-ph') }}">
