                                ...
                                <tbody id="users_table">
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-success btn-block" href="{{ url('users/' . $user->id) }}" data-toggle="tooltip" title="{{ trans('laravelusers::laravelusers.tooltips.show') }}">
                                                    {{ trans('laravelusers::laravelusers.buttons.show') }}
                                                </a>
                                            </td>
                                            <td>
                                                <a class="btn btn-sm btn-info btn-block" href="{{ url('users/' . $user->id . '/edit') }}" data-toggle="tooltip" title="{{ trans('laravelusers::laravelusers.tooltips.edit') }}">
